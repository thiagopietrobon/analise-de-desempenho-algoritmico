(() => {
    ...
    function addSectionNav() {
        ...
        nav.innerHTML =
            '<a href="#inicio" aria-label="Início" title="Início"></a><a href="#resultados" aria-label="Gráficos" title="Gráficos"></a><a href="#laboratorio" aria-label="Bancada" title="Bancada"></a><a href="#metodologia" aria-label="Metodologia" title="Metodologia"></a>';
